...
import 'package:marcador_de_truco/truco/widgets/alert_novo_jogo_truco.dart';
  ...
  void showNovoJogoTruco(context) {
    _scaffoldKey.currentState.setState(() {
      showDialog(
        ...
        builder: (context) => AlertNovoJogoTruco(
          function: () async {
            ij.novoJogo();
        ...
        builder: (context) => AlertNovaPartida(
          function: () async {
            ...
            Navigator.of(context).pushAndRemoveUntil(
                MaterialPageRoute(builder: (context) => EscolhaDoJogoTruco()),
